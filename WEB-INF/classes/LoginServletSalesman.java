...
public class LoginServletSalesman extends LoginServlet {
    ...
    */
        ...
        if(userid != null &&
            password != null) {
                ...
                if(realpassword != null &&
                    ...
                    showPage(response, "Salesman Login Success!" );
                } else {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println("<input type =\"submit\" value=\"Continue to Change Customer Order \">");
        out.println("</form>");

        out.println("<form action =\"Loginc.html\">");
        out.println("<input type =\"submit\" value=\"Create Customer Accounts \">");
        out.println("</form>");
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println("<body>");
        out.println("<h2>" + message + "</h2>");
        out.println("<form action =\"Logins.html\">");
        out.println("<input type =\"submit\" value=\"Go to Salesman Login \">");
        out.println("</form>");
        out.println("</body>");
        out.println("</html>");
        out.close();
